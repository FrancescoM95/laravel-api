...
@section('content')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('admin.projects.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Aggiungi
                progetto</a>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex gap-2 align-items-center">
                            <h3 class="card-title">{{ $project->title }} </h3><span class="badge"
                                style="background-color: {{ $project->type?->color }}">{{ $project->type ? $project->type->label : '' }}</span>
                        </div>
                    </div>
                    <div class="card-body">
                        <img src="{{ $project->printImage() }}" class="card-img-top me-3 mb-3 img-fluid"
                            alt="{{ $project->title }}">
